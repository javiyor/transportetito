    ...
    <div>
            ...
            <nav class="bg-white border-b border-gray-100">
                                ...
                                <div v-if="($page.props.tt?.roles || []).includes('admin')" class="hidden sm:flex sm:items-center">
                                    <Dropdown align="left" width="40">
                                        ...
                                        <template #content>
                                            ...
                                            <DropdownLink :href="route('admin.plan-cuentas.index')">Plan de Cuentas</DropdownLink>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <div class="px-4 pt-2 text-xs text-gray-400 pl-8">
                            — Cotizaciones —
                        </div>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).some((r) => ['facturacion', 'admin'].includes(r))"
                            :href="route('facturacion.cotizaciones.pedido.create')"
                            :active="route().current('facturacion.cotizaciones.pedido.*')"
                        >
                            Pedido
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).some((r) => ['facturacion', 'admin'].includes(r))"
                            :href="route('facturacion.cotizaciones.pendientes')"
                        ...
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).some((r) => ['facturacion', 'admin'].includes(r))"
                            :href="route('facturacion.cotizaciones.consultas')"
                            :active="route().current('facturacion.cotizaciones.consultas')"
                        >
                            Consultas
                        </ResponsiveNavLink>
                        ...
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('finanzas.movimientos-bancarios.index')"
                            :active="route().current('finanzas.movimientos-bancarios.*')"
                        >
                        ...
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('cobranzas.ctacte.index')"
                            :active="route().current('cobranzas.ctacte.*')"
                        >
                            Cta. Cte. clientes
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                        ...
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('finanzas.libro-diario')"
                            :active="route().current('finanzas.libro-diario')"
                        >
                            Libro Diario
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('finanzas.libro-mayor')"
                            :active="route().current('finanzas.libro-mayor')"
                        >
                            Libro Mayor
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('finanzas.balance')"
                            :active="route().current('finanzas.balance')"
                        >
                            Balance
                        </ResponsiveNavLink>
        ...
        >
            Usuarios
                        ...
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('admin.plan-cuentas.index')"
                            :active="route().current('admin.plan-cuentas.*')"
                        >
                            Plan de Cuentas
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('admin.arca.index')"
                            :active="route().current('admin.arca.*')"
                        >
                            ARCA
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('admin.blanqueo.ventas')"
                            :active="route().current('admin.blanqueo.ventas')"
                            class="!text-red-600"
                        >
                            Blanqueo Ventas
                        </ResponsiveNavLink>
                        <ResponsiveNavLink
                            v-if="($page.props.tt?.roles || []).includes('admin')"
                            :href="route('admin.blanqueo.compras')"
                            :active="route().current('admin.blanqueo.compras')"
                            class="!text-red-600"
                        >
                            Blanqueo Compras
                        </ResponsiveNavLink>

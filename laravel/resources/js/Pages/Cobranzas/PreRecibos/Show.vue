                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr v-if="!(preRecibo.items || []).length">
                                <td colspan="3" class="px-6 py-10 text-center text-sm text-gray-500">Sin items.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr v-if="!(preRecibo.aplicaciones || []).length">
                                <td colspan="3" class="px-6 py-10 text-center text-sm text-gray-500">Sin aplicaciones.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

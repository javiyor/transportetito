...
const applyFilters = () => {
    router.get(route('cobranzas.pre-recibos.index'), { estado: form.estado }, { preserveState: true, preserveScroll: true, replace: true });
};
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr v-if="!preRecibos.data.length">
                                <td colspan="6" class="px-6 py-10 text-center text-sm text-gray-500">No hay pre-recibos.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>

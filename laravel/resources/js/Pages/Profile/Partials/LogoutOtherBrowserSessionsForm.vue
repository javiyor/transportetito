...
<template>
    <ActionSection>
        ...
        <template #description>
            Administra y cierra sesion en tus sesiones activas en otros navegadores y dispositivos.
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                Si es necesario, podes cerrar sesion en todos tus otros dispositivos. Algunas sesiones recientes se listan abajo. Si crees que tu cuenta fue comprometida, cambia tu contrasena.
            </div>

            <!-- Other Browser Sessions -->
            <div v-if="sessions.length > 0" class="mt-5 space-y-3">
            ...
            <DialogModal :show="confirmingLogout" @close="closeModal">
                ...
                <template #content>
                    Ingresa tu contrasena para confirmar que queres cerrar sesion en tus otros dispositivos.

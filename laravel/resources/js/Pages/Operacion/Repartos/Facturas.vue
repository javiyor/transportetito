        ...
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-white shadow sm:rounded-lg overflow-hidden">
                <div class="p-6 border-b border-gray-200 flex items-center justify-between gap-4">
                    <div>
                        <h3 class="text-base font-semibold text-gray-900">Facturas emitidas (listas)</h3>
                        <p class="mt-1 text-sm text-gray-600">Selecciona facturas para armar hoja de ruta.</p>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr v-if="!facturas.length">
                                <td colspan="4" class="px-6 py-10 text-center text-sm text-gray-500">No hay facturas para los filtros seleccionados.</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
